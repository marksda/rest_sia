...
class KecamatanController extends Controller
{
    ...
    public function addAction()
    {
        ...
        try {
            $this->kecamatanService->createKecamatan($data);
    ...
    public function updateAction($idLama)
    {
        ...
        try {
            $this->kecamatanService->updateKecamatan($idLama, $dataBaru);
        } catch (ServiceException $e) {
            switch ($e->getCode()) {
                case AbstractService::ERROR_ALREADY_EXISTS:
                case AbstractService::ERROR_UNABLE_CREATE_ITEM:
    ...
    {
        try {
            $kecamatanList = $this->kecamatanService->getKecamatanList();
        } catch (ServiceException $e) {
            throw new Http500Exception(_('Internal Server Error'), $e->getCode(), $e);
        }
